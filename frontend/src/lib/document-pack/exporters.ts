...
export function downloadDocumentWord(input: DocumentPackInput, template: DocumentPackTemplate, selected: Exclude<DocumentPackTab, 'full'>, assets?: DocumentPackRenderAssets) {
  const html = `<!doctype html><html><head><meta charset="utf-8"><style>body{font-family:Arial,sans-serif;font-size:11pt;color:#172033}table{border-collapse:collapse;width:100%;margin:10px 0}th,td{border:1px solid #ccd4df;padding:6px;text-align:left}h3,h4{color:#1a2e6b}.pack-doc__head,.pack-doc__signatures{display:flex;justify-content:space-between;gap:24px}.pack-doc__head span,.pack-doc__head small,.pack-doc__signatures span,.pack-doc__signatures small{display:block}.pack-doc__signature{width:46%}.pack-doc__signature-image{display:block;width:180px;height:48px;padding-bottom:4px;border-bottom:1px solid #9aa6b4;object-fit:contain;object-position:left center}.pack-doc__signed-status{margin-top:3px;color:#657488;font-size:8pt}</style></head><body>${renderDocumentHtml(selected, input, template, assets)}</body></html>`
