...
This module is intentionally outside ``app`` and is not copied into the
production container image. It must never be imported by application startup.
"""
...
from app.db.seed import ensure_identity_defaults
...
def seed_demo_data(db: Session) -> None:
    """Populate deterministic fixtures only in local test/performance databases."""
